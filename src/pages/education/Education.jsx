            ...
            <div className="timeline-items">
                <div className="timeline-item">
                    ...
                    <div className="timeline-content">
                        <div>
                            ...
                            <h1 className='timeline-content-right timeline-content-cargo'>{language.job.jobGanadero.jobTitle}</h1>
                        </div>
                        <ul>
                ...
                <div className="timeline-item">
                    ...
                    <div className="timeline-content">
                        ...
                        <h1 className='timeline-content-cargo'>{language.job.jobBMSC.jobTitle}</h1>
                        <ul>
                ...
                <div className="timeline-item">
                    ...
                    <div className="timeline-content">
                        ...
                        <h1 className='timeline-content-right timeline-content-cargo'>{language.job.jobBnb.jobTitle}</h1>
                        <ul>
                ...
                <div className="timeline-item">
                    ...
                    <div className="timeline-content">
                        ...
                        <h1 className='timeline-content-cargo'>{language.job.jobBCP.jobTitle}</h1>
                        <ul>
