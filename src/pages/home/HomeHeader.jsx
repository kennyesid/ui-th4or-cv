  ...
  return (
    <>
      ...
      <div className="home-content">
        ...
        <div className="social-icons">
          <img src="icon-react.svg" type="image/svg+xml"></img>
          <img src="icon-typescript.svg" type="image/svg+xml"></img>
          <img src="icon-javascript.svg" type="image/svg+xml"></img>
          <img src="icon-html5.svg" type="image/svg+xml"></img>
          <img src="icon-css3-2.svg" type="image/svg+xml"></img>
          <img src="icon-bootstrap.svg" type="image/svg+xml"></img>
          <img src="icon-material.svg" type="image/svg+xml"></img>
        </div>
        <div className="social-icons">
          <img src="icon-c-2.svg" type="image/svg+xml"></img>
          <img src="icon-dot-net-2.svg" type="image/svg+xml"></img>
          <img src="icon-nodejs.svg" type="image/svg+xml"></img>
          <img src="icon-nestjs.svg" type="image/svg+xml"></img>
          <img src="icon-spring-boot.svg" type="image/svg+xml"></img>
        </div>
        <div className="social-icons">
          <img src="icons8-oracle-pl-sql.svg" type="image/svg+xml"></img>
          <img src="icon-postgres.svg" type="image/svg+xml"></img>
          <img src="microsoft-sql-server-1.svg" type="image/svg+xml" />
          <img src="icon-mongodb.svg" type="image/svg+xml" />
        </div>
        <div className="social-icons">
          <img src="icon-postman.svg" type="image/svg+xml"></img>
          <img src="icon-jira.svg" type="image/svg+xml"></img>
        </div>
      </div>
    </>
  );
