    ...
    spanish: {
        ...
        job: {
            jobGanadero: {
                ...
                three: 'A inicios de 2023, me integré a un nuevo equipo para implementar tecnologías emergentes y desarrollar un microservicio en Spring Boot. Aunque no era mi especialidad, tomé cursos en Platzi y OpenWebinars, lo que me permitió crear un servicio eficiente y escalable.',
            ...
            jobBCP: {
                ...
                three: 'Desarrollé una página administrativa para la aplicación Tus Beneficios, encargada de registrar los tickets asignados a los clientes. Esta página permite la carga de hasta 20,000 registros desde un archivo Excel. La aplicación fue desarrollada utilizando MVC4, Entity Framework y SQL Server.',
    ...
    english: {
        ...
        job: {
            jobGanadero: {
                ...
                three: 'At the beginning of 2023, I joined a new team to implement emerging technologies and develop a microservice in Spring Boot. Although it was not my specialty, I took courses on Platzi and OpenWebinars, which enabled me to create an efficient and scalable service.',
            ...
            jobBMSC: {
                ...
                three: 'Developed an Angular project to display all ATM transactions and their statuses, which allowed me to monitor and analyze system behavior during testing. This tool facilitated pattern identification and problem resolution, enhancing efficiency in transaction analysis.',
                for: ''
            },
            jobBnb: {
            ...
            jobBCP: {
                ...
                three: 'Developed an administrative page for the Tus Beneficios application, responsible for recording tickets assigned to clients. This page supports loading up to 20,000 records from an Excel file. The application was built using MVC4, Entity Framework, and SQL Server.',
